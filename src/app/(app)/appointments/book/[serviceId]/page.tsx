...
const mockServiceDetails: {
	[key: string]: { name: string; description: string; requiresNotes?: boolean };
} = {
	"sports-facility": {
		name: "Sports Facility Booking",
		description:
			"Select a date and time slot for your desired sports activity.",
		requiresNotes: true,
	},
	"health-center": {
	...
	"library-books": {
		...
		description: "Select books and a pickup time.",
		requiresNotes: false,
	}, // Simplified for now
	"academic-advising": {
		name: "Academic Advising Session",
		description: "Book a slot with your advisor.",
		requiresNotes: true,
	},
};
...
export default function BookAppointmentPage() {
	...
	const handleBooking = () => {
		...
		alert(
			`Booking confirmed for ${serviceInfo?.name} on ${selectedDate.toLocaleDateString()} at ${selectedTimeSlot}. Notes: ${notes || "N/A"} (Mock)`,
		);
	};
