...
const mockTransactions = [
	...
	},
	{
		...
		date: "2023-10-24",
		type: "Purchase",
		description: "Cafeteria Lunch (Chicken, Rice)",
		amount: "-18.50 TL",
		status: "Completed",
	},
	{
		...
		date: "2023-10-23",
		type: "Purchase",
		description: "Cafeteria Snack (Sandwich)",
		amount: "-7.00 TL",
		status: "Completed",
	},
	{
	...
	},
	{
		...
		date: "2023-10-20",
		type: "Purchase",
		description: "Cafeteria Breakfast (Simit, Tea)",
		amount: "-5.00 TL",
		status: "Completed",
	},
];
		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					View your past deposits and purchases.
				</p>
			</div>
						...
						<TableBody>
							{mockTransactions.map((txn) => (
								<TableRow key={txn.id}>
									...
									<TableCell
										className={`text-right font-medium ${txn.amount.startsWith("+") ? "text-green-600" : "text-red-600"}`}
									>
										{txn.amount}
									</TableCell>
