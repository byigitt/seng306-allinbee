...
const mockDishes = [
  { id: "d1", name: "Chicken Curry", price: "15.00", category: "Main Course", available: true },
  { id: "d2", name: "Lentil Soup", price: "8.00", category: "Soup", available: false },
  { id: "d3", name: "Beef Burger", price: "22.50", category: "Fast Food", available: true },
  { id: "d4", name: "Green Salad", price: "12.00", category: "Salad", available: true },
];
      ...
      */}
      ...
      <Card className="mb-[80px]">
        <CardHeader>
          ...
          <CardDescription>View and manage all current dishes in the cafeteria.</CardDescription>
        </CardHeader>
        <CardContent>
          {mockDishes.length > 0 ? (
                  ...
                  <Card key={`${dish.id}-mobile`} className="w-full">
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm text-primary">{dish.price} TL</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm font-medium">Status:</span>
                        <span className={`text-sm font-semibold ${dish.available ? "text-green-600" : "text-red-600"}`}>
              ...
              <div className="hidden md:block border rounded-lg">
                {mockDishes.map((dish, index) => (
                  ...
                  >
                    ...
                    <div className="w-24 text-right font-semibold text-primary">{dish.price} TL</div>
                    <div className={`w-28 text-center font-semibold ${dish.available ? "text-green-600" : "text-red-600"}`}>
                      {dish.available ? "Available" : "Unavailable"}
                    </div>
            ...
            <div className="text-center py-10">
              ...
              <p className="text-sm text-muted-foreground">Start by adding a new dish to the menu.</p>
